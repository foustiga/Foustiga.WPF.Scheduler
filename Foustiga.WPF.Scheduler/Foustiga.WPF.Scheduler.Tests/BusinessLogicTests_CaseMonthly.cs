...
{
    [TestClass]
    public class BusinessLogicTests_CaseMonthly
    {
        public BusinessLogicTests_CaseMonthly() { }
        private API.Scheduler scheduler = new();


        [TestMethod]
        public void Monthly_CheckDefaultValues()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly; //Change only Type
            ...
            using (new AssertionScope())
            {
                ...
                recurrenceInfo.Type.Should().Be(ReccurrenceType.Monthly);
        ...
        [TestMethod]
        public void Monthly_DayNumber15_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_DayNumber15_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_DayNumber31_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_DayNumber31_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_FirstMonday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_FirstThursday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_FirstMonday_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_SecondMonday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_SecondMonday_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_ThirdMonday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_ThirdMonday_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_FourthMonday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_FourthMonday_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_LasthMonday_Periodicity1()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
        ...
        [TestMethod]
        public void Monthly_LastMonday_Periodicity3()
        {
            // Arrange
            IRecurrenceInfo recurrenceInfo = API.Scheduler.CreateRecurrenceInfo();
            recurrenceInfo.Type = ReccurrenceType.Monthly;
